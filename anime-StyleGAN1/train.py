...
parser.add_argument("--max_images", dest="max_images", default=None, type=int)
...
#after changes made just for 100 images
def train(gan, d, max_images=None):
    _dir = "visual/{}/model".format(date_str)
    checkpoint_path = _dir + "/cp-{epoch:04d}.ckpt"
    os.makedirs(_dir, exist_ok=True)
    t0 = time.time()
...
if __name__ == "__main__":
    ...
    train(m, d, max_images=args.max_images)
